...
public class QrzCallsign
{
    ...
    [XmlElement("dxcc")] public int? Dxcc { get; set; }

    [XmlElement("fname")] public string? FirstName { get; set; }

    [XmlElement("name")] public string? LastName { get; set; }

    [XmlElement("addr1")] public string? Address1 { get; set; }

    [XmlElement("addr2")] public string? Address2 { get; set; }
    ...
    [XmlElement("ccode")] public int? CountryCode { get; set; }
    ...
    [XmlElement("efdate")] public string? EffectiveDate { get; set; }

    [XmlElement("expdate")] public string? ExpiryDate { get; set; }

    [XmlElement("p_call")] public string? PreviousCall { get; set; }

    [XmlElement("class")] public string? LicenseClass { get; set; }
    ...
    [XmlElement("u_views")] public int? UserViews { get; set; }

    [XmlElement("bio")] public string? Bio { get; set; }

    [XmlElement("image")] public string? Image { get; set; }

    [XmlElement("serial")] public int? Serial { get; set; }

    [XmlElement("moddate")] public string? ModifiedDate { get; set; }
    ...
    [XmlElement("GMTOffset")] public int? GmtOffset { get; set; }
    ...
    [XmlElement("cqzone")] public int? CqZone { get; set; }

    [XmlElement("ituzone")] public int? ItuZone { get; set; }
    ...
    [XmlElement("name_fmt")] public string? NameFormatted { get; set; }

    [XmlElement("born")] public int? Born { get; set; }
}