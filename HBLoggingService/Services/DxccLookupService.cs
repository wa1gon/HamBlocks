...
{
    private readonly ILogger<DxccLookupService> _logger;
    ...
    {
        if (DxccList.IsNullOrEmpty() == false) return;

        var filePath = Path.Combine(AppContext.BaseDirectory, "Data", "dxcc.json");
